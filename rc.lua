...
local batimg = wibox.widget.imagebox();
...
vicious.register(mymemwidget, vicious.widgets.mem, ' <span color="#FF663F">$2MB/$3MB</span>', 13)
...
globalkeys = awful.util.table.join(
    ...
    -- Lambros was here (toggling language)
